...
'''
def generate_box(root, input_size, batch_size, output_path):
    ...
    a = ImageDataset(root, batch_size=batch_size, transforms=transform)

    # print(classes[0])

    for class_ind in range(a.num_classes):
        print('Generating Pseudo BBs for class {}'.format(class_ind))
        #if class_ind == 10:
        #    import sys
        #    sys.exit()
        now_class_dict = {}
